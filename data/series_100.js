        ...
        spots: [
            {
                ...
                title: "Location Pin",
                eng: "A red drop-shaped pin marks the specific spot on the map, helping users find the exact location.",
                jp: "赤いしずく型のピンが地図上の特定の場所をマークし、ユーザーが正確な位置を見つけるのを助けます。",
                vocab: ["specific (特定の)", "exact (正確な)", "spot (場所)"],
                idioms: ["put on the map (有名にする/地図に載せる)"],
                synonyms: ["marker", "pointer"],
                grammar: "Help + O + 原形不定詞 (help users find) の形で、「Oが～するのを助ける」という意味になります。"
            },
            {
                top: "15%", left: "45%", width: "35%", height: "15%", color: "#2ecc71",
                title: "Landmark Label",
                eng: "The word 'Hospital' is displayed in large white letters on a blue background for easy reading.",
                jp: "「Hospital」という単語が、読みやすいように青い背景に大きな白い文字で表示されています。",
            ...
            },
            {
                ...
                eng: "To get to the entrance, you need to follow the dotted line and turn right at the intersection.",
                jp: "入り口に着くには、点線に従って交差点を右に曲がる必要があります。",
                vocab: ["follow (従う)", "intersection (交差点)", "entrance (入り口)"],
                idioms: ["around the corner (すぐ近くに)"],
                synonyms: ["junction", "crossing"],
                grammar: "Need to... は必要性を表す表現で、道案内の際によく使われるフレーズです。"
            }
        ]
    }
);
